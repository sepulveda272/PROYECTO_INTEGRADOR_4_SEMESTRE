...
class TablaTecnico extends javax.swing.JFrame {
    ...
    public TablaTecnico(/*int idProductor*/) {
     ...
     private void cargarTecnicos() {
        ...
        List<TecnicoOficial> tecnicos = tecnicoOficialController.listarTecnico();
    ...
    private void botoneditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botoneditarActionPerformed
        ...
        if (fila == -1) {
            JOptionPane.showMessageDialog(this, "Seleccione un tecnico para editar.");
            return;
        }

        int numeroRegistro = Integer.parseInt(jTable1.getValueAt(fila, 0).toString());
        ...
        String direccion = jTable1.getValueAt(fila, 7).toString();
        long celular = Long.parseLong(jTable1.getValueAt(fila, 8).toString());
        String correo = jTable1.getValueAt(fila, 9).toString();
        String estado = jTable1.getValueAt(fila, 10).toString();
    ...
    private void botoneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botoneliminarActionPerformed
        ...
        if (filaSeleccionada == -1) {
            JOptionPane.showMessageDialog(this, "Seleccione un tecnico para eliminar.");
            return;
        }

        int numeroRegistro = Integer.parseInt(jTable1.getValueAt(filaSeleccionada, 0).toString());
        int confirmacion = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar este tecnico?", "Confirmar", JOptionPane.YES_NO_OPTION);
        
        if (confirmacion == JOptionPane.YES_OPTION) {
            tecnicoOficialController.eliminarTecnico(numeroRegistro);
            cargarTecnicos();
        }
