...
class Tabla extends javax.swing.JFrame {
    ...
    public Tabla(/*int idProductor*/) {
     ...
     private void cargarProductores() {
        ...
        List<Productor> productores = productorController.listarProductores();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 10, 280, 60));
    ...
    private void botoncrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botoncrearActionPerformed
        CrearProductor crear = new CrearProductor(this::cargarProductores);
    ...
    private void botoneditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botoneditarActionPerformed
        ...
        if (fila == -1) {
            JOptionPane.showMessageDialog(this, "Seleccione un productor para editar.");
            return;
        }

        int idProductor = Integer.parseInt(jTable1.getValueAt(fila, 0).toString());
        ...
        ActualizarProductor actualizar = new ActualizarProductor(
            idProductor, numeroIdentificacion, tipoIdentificacion,
            primerNombre, segundoNombre, primerApellido, segundoApellido,
            direccion, celular, correo,estado, this::cargarProductores
        );
