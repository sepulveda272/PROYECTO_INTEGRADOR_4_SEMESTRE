 ...
 * @author omaci
 */
public class CrearTecnico extends javax.swing.JFrame {
    //private String idusuario;
    private Runnable onTecnicoGuardado;
    ...
    private void initComponents() {
        ...
        jPanel1.add(telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 440, 180, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearTecnico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrearTecnico(null).setVisible(true);
            }
        });
    }
